# Step 4A: Plan before execution

```text
Propose the exact source path, calculations, and validation checks for the approved question. Name the files or tables and the expected output.
